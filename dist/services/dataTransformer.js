...
class DataTransformer {
     ...
     */
    transformScrapingData(scrapingData, sessionInfo, executionSource = 'persistent-scraper', hasChanges = true) {
        const records = [];
        let totalRecords = 0;
        let newRecords = 0;
        ...
        scrapingData.forEach(table => {
            ...
            if (!table.isEmpty &&
                ...
                console.log(`🔍 Ignorando tabela: ${table.tableName || 'sem nome'} (isEmpty: ${table.isEmpty}, rows: ${((_a = table.rows) === null || _a === void 0 ? void 0 : _a.length) || 0})`);
            }
        });
     ...
     */
    transformDifferencesData(differences, sessionInfo, executionSource = 'persistent-scraper') {
        const records = [];
        let totalRecords = 0;
        let newRecords = 0;
        differences.forEach(diff => {
            ...
            if (diff.newRecords &&
                ...
                console.log(`🔍 Ignorando diferença: ${diff.tableName || 'sem nome'} (newRecords: ${((_a = diff.newRecords) === null || _a === void 0 ? void 0 : _a.length) || 0})`);
            }
        });
        const session = {
            total_records: totalRecords,
    ...
    saveToDatabase(transformedData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const sessionId = yield this.databaseManager.createScrapingSession(transformedData.session);
                // Inserir registros se houver dados
                if (transformedData.records.length > 0) {
                    yield this.databaseManager.insertRideData(transformedData.records);
                }
                // Finalizar sessão
                yield this.databaseManager.finishScrapingSession(sessionId);
     ...
     */
    processFullScrapingData(scrapingData_1, sessionInfo_1) {
        return __awaiter(this, arguments, void 0, function* (scrapingData, sessionInfo, executionSource = 'initial-execution') {
            ...
            return yield this.saveToDatabase(transformedData);
        });
    }
    /**
     * Processa apenas diferenças (execuções subsequentes)
     */
    processDifferentialData(differences_1, sessionInfo_1) {
        return __awaiter(this, arguments, void 0, function* (differences, sessionInfo, executionSource = 'scheduler') {
     ...
     */
    generateDifferenceHash(difference) {
        var _a, _b;
        const hashData = {
            tableName: difference.tableName,
            newRecordsCount: difference.totalNewRecords,
            firstNewRecords: ((_a = difference.newRecords) === null || _a === void 0 ? void 0 : _a.slice(0, 3).sort()) || [], // Ordenar para consistência
            dataContent: ((_b = difference.newRecords) === null || _b === void 0 ? void 0 : _b.sort()) || [] // Dados ordenados
        };
        return (0, crypto_1.createHash)('md5')
            .update(JSON.stringify(hashData))
            .digest('hex');
    ...
    getDatabaseStats() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.databaseManager.getDatabaseStats();
            }
            catch (error) {
     ...
     */
    saveDriverPersonalDetails(extractedData) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                // Verificar se o banco está disponível
                ...
                const dataHash = (0, crypto_1.createHash)('md5').update(dataString).digest('hex');
                // Verificar se os dados já existem (evitar duplicação)
                const existingData = yield this.databaseManager.getDriverPersonalDetails(extractedData.driverId);
                ...
                // Salvar no banco
                yield this.databaseManager.insertDriverPersonalDetails(record);
                console.log(`💾 Dados pessoais do motorista ${extractedData.driverId} salvos no PostgreSQL`);
                console.log(`   📊 Corridas no histórico: ${((_a = extractedData.data.rides_history) === null || _a === void 0 ? void 0 : _a.length) || 0}`);
                console.log(`   💰 Transações da carteira: ${((_b = extractedData.data.wallet_transactions) === null || _b === void 0 ? void 0 : _b.length) || 0}`);
                console.log(`   📋 Histórico de assinaturas: ${((_c = extractedData.data.subscription_history) === null || _c === void 0 ? void 0 : _c.length) || 0}`);
                return true;
            }
            catch (error) {
