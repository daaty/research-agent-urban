...
class DatabaseManager {
     ...
     */
    insertDriverPersonalDetails(record) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.pool || !this.isConnected) {
                throw new Error('Banco de dados não conectado');
            }
     ...
     */
    driverPersonalDetailsExists(driverId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.pool || !this.isConnected) {
                return false;
            }
            try {
                ...
                const result = yield this.pool.query(query, [driverId]);
     ...
     */
    getDriverPersonalDetails(driverId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.pool || !this.isConnected) {
                return null;
            }
    ...
    getDatabaseStats() {
      ...
      `;
        ...
        ORDER BY count DESC
      `;
                const [totalRecords, totalDrivers, totalPersonalDetails, totalSessions, lastScraping, lastDriversScraping, lastPersonalDetails, tableStats, driversStats, personalDetailsCityStats] = yield Promise.all([
