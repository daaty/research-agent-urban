 ...
 */
router.get('/rides', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
router.get('/rides/recent', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
router.get('/dashboard-data', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
