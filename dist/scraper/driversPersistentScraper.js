    ...
    extractDriverTableData(tableName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const headers = yield page.$$eval(`${tableSelector} thead th`, ths => ths.map(th => {
                    var _a;
                ...
                const hasData = yield page.$$(rowSelector);
                if (hasData.length === 0) {
                ...
                const rows = yield page.$$eval(rowSelector, trs => trs.map(tr => {
                    ...
                    return Array.from(tds).map(td => {
                        ...
                        if (statusSpan) {
                            text = ((_a = statusSpan.textContent) === null || _a === void 0 ? void 0 : _a.trim()) || '';
                        }
                        else {
                            // Para outros campos, pegar todo o texto
                            text = ((_b = td.textContent) === null || _b === void 0 ? void 0 : _b.trim()) || '';
                        }
...
function scrapeAllDriversDataPersistent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield scraper.scrapeAllDriversData();
    });
}
