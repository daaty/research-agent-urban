    ...
    performLogin(loginUrl, username, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.smartWait('navigation');
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (elapsedTime < maxWaitTime) {
                ...
                if (currentUrl.includes('/page/login') || currentUrl.includes('#/page/login')) {
                    ...
                    yield this.smartWait('elementWait');
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const driverData = yield this.page.evaluate((currentCity) => {
                    ...
                    function validateExtractedValue(value, expectedLabel) {
                        if (!value)
                            return null;
                        const knownLabels = [
                            'Driver ID', 'Driver Name', 'Status', 'Phone No', 'City', 'Joining Date', 'DOB',
