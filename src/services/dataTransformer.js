...
class DataTransformer {
     ...
     */
    async processFullScrapingData(scrapingData, sessionInfo, executionSource = 'initial-execution') {
     ...
     */
    async processDifferentialData(differences, sessionInfo, executionSource = 'scheduler') {
     ...
     */
    async saveDriverPersonalDetails(extractedData) {
        var _a, _b, _c;
        try {
            // Verificar se o banco está disponível
            if (!this.databaseManager.isConnectedToDatabase()) {
